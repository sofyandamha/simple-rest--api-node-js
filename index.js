...
const { matchedData, sanitize } = require('express-validator/filter'); //Sanitize Form Parameter
...
const sequelize = new Sequelize('simple-rest', 'root', '', {
    host: 'localhost',
    dialect: 'mysql',
    pool: {
        max: 5,
...
app.use(bodyParser.json()); // suppor json encoded bodies
...
app.get('/book/', (req, res) => {
    book.findAll().then(book => {
        res.json(book)
        const str = JSON.stringify(book, null, 3);
        console.log(book);
    })
})
